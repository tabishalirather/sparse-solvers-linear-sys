...
csr_steepest_descent_step(csr *A, double *r, double *p, double *x) {
  ...
  /*                                      */
  /*          TODO --- Problem 2          */
  /* Implement one step of the Steepest   */
  /* Descent method.                      */
  /*                                      */
  /* ************************************ */
...
csr_minimal_residual_step(csr *A, double *r, double *p, double *x) {
  ...
  /*                                      */
  /*          TODO --- Problem 2          */
  /* Implement one step of the Minimal    */
  /* Residual method.                     */
  /*                                      */
  /* ************************************ */
...
csr_residual_norm_steepest_descent_step(csr *A, double *r, double *v, double *w, double *x) {
  ...
  /*                                      */
  /*          TODO --- Problem 2          */
  /* Implement one step of the Residual   */
  /* Norm Steepest Descent method.        */
  /*                                      */
  /* ************************************ */
  // v = AT*r = k
  // w = Av = A*AT*r = l
  alpha = vec_dot(n, r, w) / vec_dot(n, w, w);
